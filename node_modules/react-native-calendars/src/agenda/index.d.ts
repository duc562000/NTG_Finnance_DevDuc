...
export default class Agenda extends Component<AgendaProps, State> {
    ...
    static propTypes: {
        ...
        onScrollEndDrag: PropTypes.Requireable<(...args: any[]) => any>; /** initially selected day */
        ...
        hideDayNames: PropTypes.Requireable<boolean>; /** the list of items that have to be displayed in agenda. If you want to render item as empty date
         the value of date key has to be an empty array []. If there exists no value for date key it is
         considered that the date in question is not yet loaded */
